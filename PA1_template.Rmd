...
The 5-minute interval which contains the maximum number of steps (on average across all the days in the dataset) is the **`r intvMaxSteps`** interval.
...
Total number of missing values in the dataset is **`r missval`** and missing data affects only `steps` variable. 
